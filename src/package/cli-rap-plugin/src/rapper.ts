...
import { createBaseRequestStr, createBaseIndexCode } from './src/core/base-creator';
import {
  writeFile,
  mixGeneratedCode,
  getMd5,
...
import { getInterfaces, getIntfWithModelName, uniqueItfs, creatHeadHelpStr } from './src/core/tools';
import { findDeleteFiles, findChangeFiles, findRapperVersion } from './src/core/scanFile';
